...
namespace ImGui
{
  ...
  static const ImGuiAppEditorCommand s_editor_commands[] =
  {
    ...
    { 47, "",   "Add: Region",                 "",       ImGuiKey_None,          0,              ImGuiAppCmdSurface_Palette | ImGuiAppCmdSurface_Menu | ImGuiAppCmdSurface_Gizmo, ImGuiAppNodeKind_Layout  },
    { 48, "",   "Add: Split",                  "",       ImGuiKey_None,          0,              ImGuiAppCmdSurface_Palette | ImGuiAppCmdSurface_Menu | ImGuiAppCmdSurface_Gizmo, ImGuiAppNodeKind_Layout  },
    { 49, "",   "Add: Tabs",                   "",       ImGuiKey_None,          0,              ImGuiAppCmdSurface_Palette | ImGuiAppCmdSurface_Menu | ImGuiAppCmdSurface_Gizmo, ImGuiAppNodeKind_Layout  },
  ...
  void ShowAppGraphEditor(ImGuiApp* app, ImGuiAppGraph* g, int* selected_node_id, bool show_live)
  {
    ...
    auto run_command = [&](int cmd_id, const ImVec2& at)
    {
      ...
      case 47: added = AppGraphAddNode(g, ImGuiAppNodeKind_Layout, "Region"); ImStrncpy(added->TypeName, "Region", IM_ARRAYSIZE(added->TypeName)); break;
      case 48: added = AppGraphAddNode(g, ImGuiAppNodeKind_Layout, "Split");  ImStrncpy(added->TypeName, "Split",  IM_ARRAYSIZE(added->TypeName)); break;
      case 49: added = AppGraphAddNode(g, ImGuiAppNodeKind_Layout, "Tabs");   ImStrncpy(added->TypeName, "Tabs",   IM_ARRAYSIZE(added->TypeName)); break;
  ...
  void ShowAppGraphTree(const ImGuiApp* app, ImGuiAppGraph* g, int* selected_node_id, bool show_live)
  {
    ...
    static const ImGuiAppNodeKind filter_kinds[] =
    {
      ...
      ImGuiAppNodeKind_Note, ImGuiAppNodeKind_Layout,
    };
