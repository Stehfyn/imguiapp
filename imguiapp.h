...
//-----------------------------------------------------------------------------
// [SECTION] AV recording behavior (encode config, encoder provider vtable, ring/queue policy, recorder)
// Public so clients can drive recording: supply an encoder provider, tune the encode/ring config, and
